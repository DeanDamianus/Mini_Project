...
import 'package:mini_project/kertasContent/kardusPage.dart';
import 'package:mini_project/kertasContent/kartonPage.dart';
            ...
            child: Column(
              children: <Widget>[
                ...
                GestureDetector(
                  onTap: () {
                    Navigator.push(context,
                        MaterialPageRoute(builder: (context) => koranPage()));
                  },
                  child: Container(
                    height: 100,
                    width: 350,
                ...
                GestureDetector(
                  onTap: () {
                    Navigator.push(context,
                        MaterialPageRoute(builder: (context) => arsipPage()));
                  },
                  child: Container(
                    height: 100,
                    width: 350,
                ...
                GestureDetector(
                  onTap: () {
                    Navigator.push(context,
                        MaterialPageRoute(builder: (context) => kartonPage()));
                  },
                  child: Container(
                    height: 100,
                    width: 350,
